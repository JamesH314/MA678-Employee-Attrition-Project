...
Logit(attrition) = -0.36 - 0.03*Age + 0.03* Distance - …
...
Attrition = exp(-0.36 - 0.03*Age + 0.03* Distance - …)
	    =0.70 * 0.97^Age * 1.03 ^ Distance * …
...
The binned residual plot below, Figure 5, shows that 95% of the points are within the boundaries, so the model fits good. Since I use logit multilevel model, no other residual plots are needed.
