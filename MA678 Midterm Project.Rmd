...
```{r}
#radar chart
attr_try <- attrition[,c(1, 2, 6, 11, 19, 25, 35)]
...
```{r}
#regression
fit1<-glmer(Attrition~Age+DistanceFromHome+EnvironmentSatisfaction+MonthlyIncome+RelationshipSatisfaction+YearsSinceLastPromotion+(1|JobRole) ,data = attrition, family = binomial(link = "logit"))
fixef(fit1)
